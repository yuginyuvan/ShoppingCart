...
function ShopWatchKids() {
  const dispatch = useDispatch();
  const navigate = useNavigate();
  const items = products.filter((p) => p.category === "watch" && p.gender === "kids");

  return (
    <section className="products-section">
      <div style={{ maxWidth: 1000, margin: "auto" }}>
        <h2 style={{ color: "#2e7d32" }}>Kids' Watches</h2>
        <p>Fun and durable watches designed for kids.</p>
